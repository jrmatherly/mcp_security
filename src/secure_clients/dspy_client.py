...
async def main():
    ...
    if llm_provider == 'openai':
        ...
        if not api_key or api_key == 'your-openai-api-key-here':
            ...
            print("   3. Run with: OPENAI_API_KEY='sk-...' python src/secure_clients/dspy_client.py")
            return
        ...
        if not api_key or api_key == 'your-anthropic-api-key-here':
            ...
            print("\n   Please set it in one of these ways:")
            print("   1. Edit .env file and replace 'your-anthropic-api-key-here' with your actual key")
            print("   2. Set environment variable: export ANTHROPIC_API_KEY='sk-ant-...'")
            print("   3. Run with: ANTHROPIC_API_KEY='sk-ant-...' python src/secure_clients/dspy_client.py")
            return
    else:
    ...
    try:
        ...
        print(f"   2. Start MCP server in HTTP mode: LLM_PROVIDER={llm_provider} task run-server")
