...
async def main():
    ...
    if not anthropic_api_key or anthropic_api_key == 'your-anthropic-api-key-here':
        ...
        print("   3. Run with: ANTHROPIC_API_KEY='sk-ant-...' python src/secure_clients/anthropic_client.py")
        return
    ...
    try:
        ...
        print("   2. Start MCP server in HTTP mode: LLM_PROVIDER=anthropic task run-server")
        print("   3. Then run this client: python src/secure_clients/anthropic_client.py")
